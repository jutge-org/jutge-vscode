...
export class TablesService {
   ...
   * @throws ApiError
   */
  public static getLanguage(languageId: string): CancelablePromise<{
    language_id: string;
    eng_name: string;
    own_name: string;
  }> {
   ...
   * @throws ApiError
   */
  public static getCountry(countryId: string): CancelablePromise<{
    country_id: string;
    eng_name: string;
  }> {
    return __request(OpenAPI, {
   ...
   * @throws ApiError
   */
  public static getCompiler(compilerId: string): CancelablePromise<{
    compiler_id: string;
    name: string;
    language: string;
    extension: string;
   ...
   * @throws ApiError
   */
  public static getDriver(driverId: string): CancelablePromise<{
    driver_id: string;
  }> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static getVerdict(verdictId: string): CancelablePromise<{
    verdict_id: string;
    name: string;
    description: string;
  }> {
