...
export class MyProblemsService {
     ...
     * @throws ApiError
     */
    public static getAbstractProblem(
        problemNm: string,
    ): CancelablePromise<{
        problem_nm: string;
        author: (null | string);
     ...
     * @throws ApiError
     */
    public static getAbstractProblemExtras(
        problemNm: string,
    ): CancelablePromise<{
     ...
     * @throws ApiError
     */
    public static getHtmlStatement(
        problemNm: string,
        problemId: string,
     ...
     * @throws ApiError
     */
    public static getTextStatement(
        problemNm: string,
        problemId: string,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
