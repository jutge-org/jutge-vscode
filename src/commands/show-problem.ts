...
export const commandRefreshTree = (treeProvider: JutgeCourseTreeProvider) => () => {
    treeProvider.refresh()
}

export const commandShowProblem =
    (context: vscode.ExtensionContext, treeProvider: JutgeCourseTreeProvider) =>
